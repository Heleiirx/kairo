...
function FocusTimer() {
  ...
  return (
    <div className="bg-primary rounded-lg p-4 h-full flex flex-col">
        ...
        <div className="relative w-32 h-32">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <button
              ...
              className="mt-1 px-3 py-0.5 border border-secondary text-secondary text-xs rounded hover:bg-secondary hover:text-white transition"
            >
